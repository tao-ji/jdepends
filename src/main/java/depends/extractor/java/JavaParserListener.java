...
public interface JavaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#typeCast}.
	 * @param ctx the parse tree
	 */
	void enterTypeCast(JavaParser.TypeCastContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#typeCast}.
	 * @param ctx the parse tree
	 */
	void exitTypeCast(JavaParser.TypeCastContext ctx);
	/**
